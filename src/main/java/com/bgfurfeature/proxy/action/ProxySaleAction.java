package com.bgfurfeature.proxy.action;

import org.junit.Test;

import com.bgfurfeature.proxy.proxyclass.ProxyBoss;
import com.bgfurfeature.proxy.service.IBoss;
import com.bgfurfeature.proxy.service.impl.Boss;

/**
 * 什么是动态代理？ 简单的写一个模板接口，剩下的个性化工作，好给动态代理来完成！
 * 多了一个 中间 过程( 可以保证原先的代码不变， 扩展新的需求)
 */
