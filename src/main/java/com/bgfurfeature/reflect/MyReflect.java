...
public class MyReflect {
	...
	/**
	 * 反射Person类
	 * 添加单元测试的注解，可以单独对函数进行测试运行
	 * @throws Exception 
	 */
	@Before
	public void init() throws Exception {
		className = "com.bigchange.reflect.Person";
	...
	public void otherMethod() throws Exception {
		...
		System.out.println(Class.forName("com.bigchange.reflect.City").isEnum());
		
		//判断当前的Class对象表示是否是接口
		System.out.println(personClass.isInterface());
		System.out.println(Class.forName("com.bigchange.reflect.TestInterface").isInterface());
