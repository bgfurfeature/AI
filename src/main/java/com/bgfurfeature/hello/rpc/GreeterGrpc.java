...
public final class GreeterGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.bgfurfeature.hello.rpc.HelloRequest,
      ...
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "com.bgfurfeature.hello.rpc.Greeter", "SayHelloAgain"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.bgfurfeature.hello.rpc.HelloRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.bgfurfeature.hello.rpc.HelloReply.getDefaultInstance()));
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.bgfurfeature.hello.rpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.bgfurfeature.hello.rpc.HelloReply> responseObserver) {
     ...
     * </pre>
     */
    public void sayHelloAgain(com.bgfurfeature.hello.rpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.bgfurfeature.hello.rpc.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.bgfurfeature.hello.rpc.HelloRequest,
                com.bgfurfeature.hello.rpc.HelloReply>(
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractStub<GreeterBlockingStub> {
     ...
     * </pre>
     */
    public com.bgfurfeature.hello.rpc.HelloReply sayHello(com.bgfurfeature.hello.rpc.HelloRequest request) {
     ...
     * </pre>
     */
    public com.bgfurfeature.hello.rpc.HelloReply sayHelloAgain(com.bgfurfeature.hello.rpc.HelloRequest request) {
      return blockingUnaryCall(
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractStub<GreeterFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.bgfurfeature.hello.rpc.HelloReply> sayHello(
        com.bgfurfeature.hello.rpc.HelloRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.bgfurfeature.hello.rpc.HelloReply> sayHelloAgain(
        com.bgfurfeature.hello.rpc.HelloRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.bgfurfeature.hello.rpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.bgfurfeature.hello.rpc.HelloReply>) responseObserver);
          break;
        case METHODID_SAY_HELLO_AGAIN:
          serviceImpl.sayHelloAgain((com.bgfurfeature.hello.rpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.bgfurfeature.hello.rpc.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static final class GreeterDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.bgfurfeature.hello.rpc.Hello.getDescriptor();
    }
  }
